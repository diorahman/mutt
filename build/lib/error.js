...
var MuttError = function (_BaseError) {
    _inherits(MuttError, _BaseError);

    function MuttError(message, code) {
        var source = arguments.length <= 2 || arguments[2] === undefined ? 'Mutt' : arguments[2];

        _classCallCheck(this, MuttError);

        var _this2 = _possibleConstructorReturn(this, Object.getPrototypeOf(MuttError).call(this, message + ' (' + code + ' of ' + source + ')'));
